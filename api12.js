...
// function AssignWorkingDays(frm, month, day){
// 	console.log("props", frm, month, day)
// 	var m_1 = 26;
// 	var m_2 = 26;
// 	var m_3 = 26;
// 	var m_4 = 26;
...
// 	frappe.model.add_child("no", "No of working days",
// 	var table = frm.doc.no;
...
// 			month_totals[month] += child.total;
// 		} else {
// 			month_totals[month] = child.total;
// 		}

// 		console.log("month total", month_totals);
...
frappe.ui.form.on('Holidayss', {
	from_date: function(frm, cdt, cdn) {
		...
		if(child.from_date && child.to_date){
			...
			// AssignWorkingDays(frm, child.month, day_diff);
		}
                    ...
                    frappe.call({
                        ...
                        $.each(r.message, function(_i, e){
                            ...
                            if(planned_qty) {
                                ...
                                entryOne.m_1 = planned_qty/26;
                                entryOne.m_2 = planned_qty/25;
                                entryOne.m_3 = planned_qty/26;
                                entryOne.m_4 = planned_qty/24;
                                entryOne.m_5 = planned_qty/26;
                                entryOne.m_6 = planned_qty/24;
