...
class NearByOrderScreen extends StatefulWidget {
  static const routeName = '/NearByOrderScreen';

  const NearByOrderScreen({super.key});

  @override
  State<NearByOrderScreen> createState() => _NearByOrderScreenState();
}

class _NearByOrderScreenState extends State<NearByOrderScreen> {
            ...
            child: Column(
              children: [
                Padding(
                    ...
                    child: TopBar(title: "Nearby Orders")),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              value: _nearByDistanceValue,
                              items: _nearByDistanceDropDowns(),
                              onChanged: (value) {
                                setState(() {
